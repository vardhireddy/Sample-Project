...
public class ContractSteps {
    ...
    public void whenTheParametersExistInRepo() throws Exception {
        retrieveResult = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/datacatalog/validation/contract/1?orgId=orgId"));
    }
    ...
    public void whenTheParametersDoesNotExistInRepo() throws Exception {
        retrieveResult = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/datacatalog/validation/contract/1?orgId=invalidOrgId"));
    }
