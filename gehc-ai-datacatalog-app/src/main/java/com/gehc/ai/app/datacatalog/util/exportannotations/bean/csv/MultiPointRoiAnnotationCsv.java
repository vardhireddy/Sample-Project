...
public class MultiPointRoiAnnotationCsv extends RoiAnnotationCsv {
     ...
     */
    public MultiPointRoiAnnotationCsv(String seriesUID, String annotationTypeAsStr, List<String> instances, String coordSys, List<List<Double>> data, String localID, String name, Integer index) {
     ...
     * @param index               (Optional) The frame index this ROI is associated with
     */
    public MultiPointRoiAnnotationCsv(String fileName, String spaceID, String annotationTypeAsStr, List<String> instances, String coordSys, List<List<Double>> data, String localID, String name, Integer index) {
