...
import com.gehc.ai.app.datacatalog.entity.Creator;
...
//                        + " acq_date, acq_time, description, institution, equipment, instance_count, im.upload_by, im.upload_date, im.properties, p.patient_id, im.instance_count, p.age, p.gender FROM image_set im  "
...
//                        + " acq_time, description, institution, equipment, instance_count, imgSet.upload_by, imgSet.upload_date, imgSet.properties, p.patient_id, imgSet.instance_count, p.age, p.gender "
...
//         * (non-Javadoc)
//         * 
//         * @see IDataCatalogDao#getDataCatalog()
//         */
//        @Override
...
//                                queryBuilder = queryBuilder.append(" where a.org_id = ? and a.id = ? and json_extract(a.data, '$.type') = ? ");
...
//                            }else{
//                                queryBuilder = queryBuilder.append(" where  a.org_id = ? and a.id = ? ");
...
//                                queryBuilder = queryBuilder.append(" where a.org_id = ? and json_extract(a.data, '$.type') = ? ");
...
//                                },      new DataCollectionRowMapper());
//                            }else{
//                                queryBuilder = queryBuilder.append(" where a.org_id = ? ");
...
//
//    /* (non-Javadoc)
//     * @see IDataCatalogDao#getImageSetByPatientId(java.lang.String)
//     */
//    @Override
...
//
//    /* (non-Javadoc)
//     * @see IDataCatalogDao#updateDataCollection(DataCollection)
//     */
//    @Override
